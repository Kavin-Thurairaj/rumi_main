...
// ← Remove the Header import entirely
    ...
    <>
      ...
      <header style={{
        ...
        <Link to="/" style={{
          ...
          borderRadius: '8px', border: '1.5px solid #c8d9ff',
          background: '#f0f5ff',
        }}>
        ...
        <Link to="/" style={{
          ...
          <span style={{ fontSize: '0.98rem', fontWeight: 800, color: '#0b1d40', letterSpacing: '-0.2px' }}>
            Rumi Rentals
          </span>
        </Link>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
          <Link to="/login" style={{
            ...
            color: '#003f8a', fontSize: '0.86rem', fontWeight: 600,
            textDecoration: 'none', border: '1.5px solid #c8d9ff',
          }}>
            Sign In
          </Link>
